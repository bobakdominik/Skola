...
public class Stvorec {
    ...
    /**
     * Vytvor nový štvorec zvolenej farby na zvolenej pozícii.
     */
    public Stvorec(int x, int y, int strana, String farba) {
        this.strana = strana;
        this.lavyHornyX = x;
        this.lavyHornyY = y;
        this.farba = farba;

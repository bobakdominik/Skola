...
namespace structures
{
    ...
    ExplicitStack<T>::~ExplicitStack()
    {
        //Done 05: ExplicitStack ~ExplicitStack
        delete this->list_;
        this->list_ = nullptr;
    }
    ...
    {
        //Done 05: ExplicitStack assign
        if (this != &other)
        {
            ExplicitStack<T>& otherS = dynamic_cast<ExplicitStack<T>&>(other);

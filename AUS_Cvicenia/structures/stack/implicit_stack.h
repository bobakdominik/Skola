...
namespace structures
{
	...
	ImplicitStack<T>::~ImplicitStack()
	{
		//Done 05: ImplicitStack ~ImplicitStack
		delete this->list_;
		this->list_ = nullptr;
	}
	...
	{
		//Done 05: ImplicitStack assign
		if (this != &other)
		{
			ImplicitStack<T>& otherS = dynamic_cast<ImplicitStack<T>&>(other);
			this->list_->assign(*otherS.list_);
		}
		return *this;
	}
	...
	{
		//Done 05: ImplicitStack equals
		if (this == &other)
		{
			return true;
		}
		ImplicitStack<T>* otherS = dynamic_cast<ImplicitStack<T>*>(&other);
		return otherS != nullptr && this->list_->equals(*otherS->list_);
	}

	template<typename T>
	size_t ImplicitStack<T>::size()
	{
		//Done 05: ImplicitStack size

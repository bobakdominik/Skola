...
namespace structures
{
	...
	{
		//Done 07: KWayTreeNode<T> ~KWayTreeNode
		for (int i = 0; i < K; i++)
		{
	...
	{
		//Done 07: KWayTreeNode<T> shallowCopy
	...
	{
		//Done 07: KWayTreeNode<T> insertSon
	...
	{
		//Done 07: KWayTreeNode<T> replaceSon
	...
	{
		//Done 07: KWayTreeNode<T> removeSon

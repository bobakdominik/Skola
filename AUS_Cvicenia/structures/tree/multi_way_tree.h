...
namespace structures
{
	...
	{
		//Done 07: MultiWayTreeNode<T> ~MultiWayTreeNode
	...
	{
		//Done 07: MultiWayTreeNode<T> shallowCopy
	...
	{
		//Done 07: MultiWayTreeNode<T> isLeaf
	...
	{
		//Done 07: MultiWayTreeNode<T> getSon
	...
	{
		//Done 07: MultiWayTreeNode<T> insertSon
		if (son == nullptr) {
	...
	{
		//Done 07: MultiWayTreeNode<T> replaceSons
		if (son == nullptr) {
	...
	{
		//Done 07: MultiWayTreeNode<T> removeSon
	...
	{
		//Done 07: MultiWayTreeNode<T> degree

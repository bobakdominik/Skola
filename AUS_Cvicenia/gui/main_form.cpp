...
void main(array<String^>^)
{
	...
	structures::FileLogConsumer* fileLogConsumer = new structures::FileLogConsumer("AUS_log.csv");
...
// MainForm:
	...
	{
		String^ str = "Size: " + size + ", Duration: " + duration.count() + " us, " + gcnew String(message.c_str());
